...
from edgetpu.nms import non_max_suppression
import cv2
import json

from edgetpu.utils import plot_one_box, Colors, get_image_tensor
...
class Model:
    ...
    def process_predictions(self, det, output_image, pad, output=True, hide_labels=False, hide_conf=False):
        """
